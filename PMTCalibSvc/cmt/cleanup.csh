...
=======
${CMTROOT}/mgr/cmt cleanup -csh -pack=PMTCalibSvc -version=v0 -path=/junofs/users/yumiao/reconstruction/dev_juno/git_repo/calibRec_juno  $* >${cmtPMTCalibSvctempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/mgr/cmt cleanup -csh -pack=PMTCalibSvc -version=v0 -path=/junofs/users/yumiao/reconstruction/dev_juno/git_repo/calibRec_juno  $* >${cmtPMTCalibSvctempfile}"
>>>>>>> feature-ym
