...
${CMTROOT}/mgr/cmt cleanup -csh -pack=PMTCalib -version=v0 -path=/junofs/users/zhangxt/github/calibRec_juno  $* >${cmtPMTCalibtempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/mgr/cmt cleanup -csh -pack=PMTCalib -version=v0 -path=/junofs/users/zhangxt/github/calibRec_juno  $* >${cmtPMTCalibtempfile}"
