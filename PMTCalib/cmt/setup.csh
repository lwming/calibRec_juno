...
${CMTROOT}/mgr/cmt setup -csh -pack=PMTCalib -version=v0 -path=/junofs/users/zhangxt/github/calibRec_juno  -no_cleanup $* >${cmtPMTCalibtempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/mgr/cmt setup -csh -pack=PMTCalib -version=v0 -path=/junofs/users/zhangxt/github/calibRec_juno  -no_cleanup $* >${cmtPMTCalibtempfile}"
