...
source /afs/ihep.ac.cn/soft/juno/JUNO-ALL-SLC6/Pre-Release/J19v1r0-Pre3/offline/Calibration/PMTCalib/cmt/cleanup.sh
...
(time python /junofs/users/zhangxt/github/calibRec_juno/PMTCalib/share/run.py --evtmax 20 --input /junofs/users/zhangxt/20inch/rec/deconvolution/runs/elec.list --step 1 --output test.root) >& test.txt
