...
(time python /junofs/users/zhangxt/github/calibRec_juno/PMTCalib/share/run.py --evtmax 500 --input /junofs/users/zhangxt/20inch/rec/deconvolution/runs/elec.list --step 2 --output SPE_v19_test.root) >& SPE-log-v19-step2_test.txt
popd
