...
${CMTROOT}/mgr/cmt cleanup -sh -pack=PMTCalibAlg -version=v0 -path=/junofs/users/zhangxt/github/calibRec_juno  $* >${cmtPMTCalibAlgtempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/mgr/cmt cleanup -sh -pack=PMTCalibAlg -version=v0 -path=/junofs/users/zhangxt/github/calibRec_juno  $* >${cmtPMTCalibAlgtempfile}"
  cmtcleanupstatus=2
